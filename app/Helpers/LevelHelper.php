...
if (!function_exists('DummyFunction')) {
    ...
    function level($user)
    {
        ...
        //     $level = 'Elite';
        // }
        // else if ($left > 2 && $left <= 9 && $middle > 2 && $middle <= 9 && $right > 2 && $right <= 9) {
        //     $level = 'Executive Elite';
        // }
        // else if ($left > 9 && $left <= 50 && $middle >9 && $middle <= 50 && $right > 9 && $right <= 50) {
        //     $level = 'Executive';
        // }
        // else if ($left > 50 && $left <= 120 && $middle > 50 && $middle <= 120 && $right > 50 && $right <= 120) {
        //     $level = 'Senior Executive';
        // }
        // else if ($left > 120 && $left <= 360 && $middle > 120 && $middle <= 360 && $right > 120 && $right <= 360) {
        //     $level = 'Assistant Manager';
        // }
        // else if ($left > 360 && $left <= 1080 && $middle > 360 && $middle <= 1080 && $right > 360 && $right <= 1080) {
        //     $level = 'Manager';
        // }
        // else if ($left > 1080 && $left <= 3240 && $middle > 1080 && $middle <= 3240 && $right > 1080 && $right <= 3240) {
        //     $level = 'General Manager';
        // }
        // else if ($left > 3240 && $left <= 9270 && $middle > 3240 && $middle <= 9270 && $right > 3240 && $right <= 9270) {
        //     $level = 'National Manager';
        // }
        // else if ($left > 9270 && $left <= 29160 && $middle > 9270 && $middle <= 29160 && $right > 9270 && $right <= 29160) {
        //     $level = 'Director';
        // }
        // else if ($left > 29160 && $left <= 87480 && $middle > 29160 && $middle <= 87480 && $right > 29160 && $right <= 87480) {
        //     $level = 'Presidential Director';
        // }
        // else if ($left >= 87480 && $middle >= 87480 && $right >= 87480) {

...
@section('title', 'Tree View By Referer User')
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Tree View By Referer User</h1>
            </div>
            <div class="col-sm-6">
                ...
                <div class="genealogy-tree">
                    <ul>
                        <li>
                            <a href="javascript:void(0);">
                                <div class="member-view-box">
                                    <div class="member-image">
                                        <img src="{{$user->avatar != 'default.png' ? '/uploads/member/'.Auth::user()->avatar:'https://image.flaticon.com/icons/svg/145/145867.svg'}}" alt="Member">
                                        <div class="member-details">
                                            <strong>
                                                @if ($user->direction == 1)
                                                    Left
                                                @elseif ($user->direction == 2)
                                                    Middle
                                                @else 
                                                    Right
                                                @endif
                                            </strong><br>
                                            <strong>{{$user->referer_id}}</strong>
                                            <h3>{{$user->username}}</h3>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="active">
                                @foreach ($user->orderByChildren() as $key => $children_one)
                                <li>
                                    <a href="{{route('admin.team.tree.view.id', $children_one->id)}}">
                                        <div class="member-view-box">
                                            <div class="member-image">
                                    ...
                                    <ul class="active">
                                        ...
                                        <li>
                                            <a href="{{route('admin.team.tree.view.id', $children_two->id)}}">
                                                <div class="member-view-box">
                                                    <div class="member-image">
